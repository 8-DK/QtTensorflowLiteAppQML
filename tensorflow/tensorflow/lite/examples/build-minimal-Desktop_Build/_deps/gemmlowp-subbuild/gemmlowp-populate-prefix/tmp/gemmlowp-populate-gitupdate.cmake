...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" show-ref fda83bdc38b118cc6b56753bd540caa49e570745
  WORKING_DIRECTORY "E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/gemmlowp"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" rev-list --max-count=1 fda83bdc38b118cc6b56753bd540caa49e570745
  WORKING_DIRECTORY "E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/gemmlowp"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/gemmlowp/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/gemmlowp/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()

...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" show-ref 0cb0880d91581d34f96899c86fc1bf35627b4b81
  WORKING_DIRECTORY "E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/opengl_headers"
...
if("${show_ref_output}" MATCHES "refs/remotes/0cb0880d91581d34f96899c86fc1bf35627b4b81")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0cb0880d91581d34f96899c86fc1bf35627b4b81")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "0cb0880d91581d34f96899c86fc1bf35627b4b81")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" rev-list --max-count=1 0cb0880d91581d34f96899c86fc1bf35627b4b81
  WORKING_DIRECTORY "E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/opengl_headers"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/KhronosGroup/OpenGL-Registry.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/opengl_headers/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/pdrl/GCSObjectDetection/tensorflow/tensorflow/lite/examples/build-minimal-Desktop_Build/opengl_headers/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
